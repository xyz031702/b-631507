      ...
      <div className="bg-white p-8 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          <div className="bg-orange-50 p-4 rounded">
            <h3 className="text-lg font-semibold text-orange-600 mb-2">Billed by</h3>
            <p>{yourCompany.name || 'Your Company Name'}</p>
            <p>{yourCompany.address || 'Your Company Address'}</p>
          </div>
          <div className="bg-orange-50 p-4 rounded">
            <h3 className="text-lg font-semibold text-orange-600 mb-2">Billed to</h3>
            <p>{billTo.name || 'Client Name'}</p>
            <p>{billTo.address || 'Client Address'}</p>
          </div>
        </div>

        <table className="w-full mb-8 rounded-lg border border-orange-600">
        ...
        {notes && (
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-orange-600 mb-2">Additional Notes</h3>
            <p>{notes}</p>
          </div>
        )}
      </div>
